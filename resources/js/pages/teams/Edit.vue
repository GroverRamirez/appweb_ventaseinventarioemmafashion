    ...
    <div class="flex flex-col space-y-10">
        ...
        <div v-if="permissions.canUpdateTeam" class="space-y-6">
            <Heading
                ...
                description="Actualiza el nombre y configuración del equipo"
            />
                ...
                <Heading
                    ...
                    :description="
                        permissions.canCreateInvitation
                            ? 'Administra quiénes pertenecen a este equipo'
                            : ''
                    "
                />
        ...
        <div v-if="invitations.length > 0" class="space-y-6">
            <Heading
                ...
                description="Invitaciones que aún no se han aceptado"
            />
