...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La autenticación en dos pasos ya está activa. Escanea el código QR o ingresa la clave en tu aplicación autenticadora.',
            buttonText: 'Cerrar',
        };
    }
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="relative bg-card px-2 py-1"
                                >o ingresa la clave manualmente</span
                            >
                        </div>
